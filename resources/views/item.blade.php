...
<div class="container">
  ...
  @endif
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header" id="JudulItem">
                    Tambah item
                </div>
                <div class="card-body">
                    <form id="createjir" action="{{route('Send-item')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                 <div class="col-12">
...
<script type="text/javascript">
    function edit(a) {
       document.getElementById("JudulItem").innerHTML="Edit Item";
